                            ...
                            const J = {
                                ...
                                template: (t, e) =>
                                    `<div class='${t.classes.top}'>\n    ${t.paging && t.perPageSelect
                                        ...
                                        }' type='search' title='${t.labels.searchTitle}'${e.id ? ` aria-controls="${e.id}"` : ""
                                        }>\n        </div>`
                                        : ""
                                    }\n</div>\n<div class='${t.classes.container}'${t.scrollY.length
                                            ...
                                            o.insertBefore(
                                                s("div", {
                                                    ...
                                                    html: [
                                                        ...
                                                        `<input class='${this.options.classes.input
                                                        }' value='${n(
                                                            t.text || String(t.data) || ""
                                                        )}' type='text'>`,
                                                        "</div>",
                                    ...
                                    if (a.length) {
                                        ...
                                        if (
                                            ...
                                            (e.href = encodeURI(`data:text/csv;charset=utf-8,${t}`)),
                                                (e.download = `${i.filename || "datatable_export"
                                                    }.csv`),
                                ...
                                (exports.exportJSON = function (e, s = {}) {
                                    ...
                                    if (a.length) {
                                        ...
                                        if (i.download) {
                                            ...
                                            (n.href = s),
                                                (n.download = `${i.filename || "datatable_export"
                                                    }.json`),
